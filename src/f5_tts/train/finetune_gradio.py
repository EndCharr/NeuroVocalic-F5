...
with gr.Blocks(theme=gr.themes.Soft(primary_hue="cyan", secondary_hue="indigo"), css=custom_css) as app:
    gr.Markdown(
        """
# NeuroVocalic-F5 Automatic Finetune
### Creador: EndCharr | Autor: Academia EndCharr

This is a local web UI for NeuroVocalic-F5 with advanced batch processing support. Optimized for Spanish by Academia EndCharr.

Original research:
* [F5-TTS](https://arxiv.org/abs/2410.06885) (A Fairytaler that Fakes Fluent and Faithful Speech with Flow Matching)
* [E2 TTS](https://arxiv.org/abs/2406.18009) (Embarrassingly Easy Fully Non-Autoregressive Zero-Shot TTS)

For tutorial and updates check here (https://github.com/EndCharr/NeuroVocalic-F5)
"""
    )
