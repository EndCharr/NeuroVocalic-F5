...
* [EndCharr](https://github.com/EndCharr) y [Academia EndCharr](https://github.com/EndCharr) por la versión NeuroVocalic-F5
...
with gr.Blocks(theme=gr.themes.Soft(primary_hue="cyan", secondary_hue="indigo"), css=custom_css) as app:
    gr.Markdown(
        """
# NeuroVocalic-F5
### Creador: EndCharr | Autor: Academia EndCharr

Esta es una interfaz web para NeuroVocalic-F5, una mejora de F5-TTS optimizada para castellano por Academia EndCharr.

Implementación original:
* [F5-TTS](https://arxiv.org/abs/2410.06885) (A Fairytaler that Fakes Fluent and Faithful Speech with Flow Matching)
* [Spanish-F5](https://github.com/jpgallegoar/Spanish-F5) por jpgallegoar
